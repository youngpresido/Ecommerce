...
return [
    ...
    */
    ...
    'cloudName'  => env('CLOUDINARY_CLOUD_NAME','abaglobal'),
    ...
    'apiKey'     => env('CLOUDINARY_API_KEY','673556462363849'),
    'apiSecret'  => env('CLOUDINARY_API_SECRET','pdOmUJxmFx7FzFsIWeaWdcb9o8Y'),
